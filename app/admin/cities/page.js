...
export default function Cities() {
  ...
  const handleCreateCity = (e) => {
    ...
    axios
      .post("https://api.assignhome.ca/api/city/", citydata)
      .then((res) => {
        setRefetch(!refetch);
  ...
  const handleUpdateCity = (e) => {
    ...
    axios
      .put(`https://api.assignhome.ca/api/city/${citydata.id}/`, citydata)
      .then((res) => {
        setModalOpen(false);
        setIsEdit(false);
        setRefetch(!refetch);
  ...
  const handleDelete = (e, id) => {
    ...
    swal({
      ...
      if (willDelete) {
        axios
          .delete(`https://api.assignhome.ca/api/city/${id}/`)
          .then((res) => {
            setRefetch(!refetch);
            swal({
  ...
  const handleEdit = (e, id) => {
    e.preventDefault();
    axios
      .get(`https://api.assignhome.ca/api/city/${id}/`)
      .then((res) => {
        setModalOpen(true);
        setIsEdit(true);
